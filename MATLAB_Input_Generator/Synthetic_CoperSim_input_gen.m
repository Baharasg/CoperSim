...
%         for p = 1:10 % we may want to process only a few partitions as
                ...
                for j = 1:size_C(2)
                    if (nnz(C{i,j})> 0) % if a block is not zero                     
                        ...
                        % fprintf(stats,'%d %d %d %d %d\n', p_i, p_j, i, j, nnz(C{i,j}));
                         ...
                         total_nz_blocks = total_nz_blocks + 1;
                         total_nz = total_nz + nnz(C{i,j});
        ...
        fprintf(stats,'total_nz_blocks %d\n', total_nz_blocks);
        fprintf(stats,'total_nz_rows %d\n', total_nz_row);
        ...
        fprintf(stats,'mean_nz_row_per_nz_blocks %d\n', avg_nz_row);
        
        fprintf(stats,'max_nz_row %d\n', max_nz_row);
        
        avg_nz_per_nz_row = total_nz / total_nz_row;
        fprintf(stats,'avg_nz_per_nz_row %d\n', avg_nz_per_nz_row);
